...
Si possono sfogliare le raccolte di amici, artisti e celebrità o creare delle tue playlist personali per ogni stato d'animo.
...
oreArtistaUno <- mySpotify_2 %>%
  ...
  #ylim(0, 68)+
  ggtitle("artisti: The Lumineers, Halsey, Demi Lovato, FLETCHER, Khalid (1° p") +
  gghighlight(artistName == "The Lumineers" || artistName == "Halsey" || artistName == "Demi Lovato" || artistName == "FLETCHER" || artistName == "Khalid" || artistName == "Taylor Swift" || artistName == "Lana Del Rey" || artistName == "Chase Atlantic" || artistName == "Lorde" || artistName == "blink-182" || artistName == "Avril Lavigne" || artistName == "Sasha Alex Sloan")
...
oreArtistaDue <- mySpotify_2 %>%
  ...
  gghighlight(artistName == "Taylor Swift" || artistName == "Lana Del Rey" || artistName == "Chase Atlantic" || artistName == "Lorde" || artistName == "blink-182" || artistName == "Avril Lavigne" || artistName == "Sasha Alex Sloan" || artistName == "The Lumineers" || artistName == "Halsey" || artistName == "Demi Lovato" || artistName == "FLETCHER" || artistName == "Khalid")
...
Fun fact: taylor swift complete collection: 267 brani, lana del rey complete collection: 107 brani
...
# Quadrante emotivo dei miei artisti più ascoltati nell'ultimo mese (luglio)
...
#shortTermArtists<-shortTermArtists[!(shortTermArtists$name=="Halsey" | shortTermArtists$name=="Anne-Marie" | shortTermArtists$name=="Demi Lovato"),]
...
quadranteEmotivo <- ggplot(data = topFiveArtists, aes(x = valence, y = energy, color = artist_name)) +
  ...
  annotate('text', 0.17, 0.95, label = "Energetico/Arrabbiato", fontface = "bold") +
...
# Generi più ascoltati nell'ultimo mese (luglio)
...
Dall’analisi appena conclusa ho potuto constatare che i cambiamenti di maggior rilievo nei miei ascolti musicali sono stati dapprima l’acquisto dell’abbonamento premium (febbraio 2020) ma soprattutto e in maniera più radicale, il periodo di isolamento causa covid (fine marzo 2020). È infatti evidente come questo periodo abbia influito negativamente sul mio umore e di conseguenza mi abbia portato ad avvicinarmi ad una musica più triste, arrabbiata e nostalgica in cui tutt’ora mi rispecchio.
